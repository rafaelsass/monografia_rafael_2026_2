---
title: "Impacto da Redução de Dimensionalidade na Clusterização"
subtitle: "Amate, Bakhtyari, Roy & Makarenkov (2026)"
lang: pt
format:
  html:
    toc: true
...
> *"Data points become nearly equidistant and classical notions of similarity lose discriminative power"*
> — Amate et al. (2026)
...
![A maldição da dimensionalidade: estrutura clara em 2D (esq.), coeficiente de variação das distâncias caindo com $d$ (centro), mesmos dados em 50D projetados via PCA — estrutura desaparece (dir.)](fig1_motivacao.png){fig-align="center" width="100%"}
